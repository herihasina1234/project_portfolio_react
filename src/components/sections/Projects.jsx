            ...
            <div className="max-w-5xl mx-auto px-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="p-6 rounded-xl border border-white/10 hover:-translate-y-1 hover:border-indigo-500/30 hover:shadow-[0_2px_8px_rgba(59,130,246,0.2)] transition">
                        ...
                        A beauty salon website allowing clients to manage their appointments, employees to manage their work and income, and administrators to manage staff, services, and salon statistics.
                        </p>
                        <div className="flex flex-wrap gap-2 mb-4">
                        {["Angular", "Node.js", "express", "MongoDB"].map((tech, key) => (
                            <span
                            key={key}
                        ...
                        <a
                            href="https://projet-salon-de-beaute-front.vercel.app/"
                            className="text-indigo-400 hover:text-blue-300 transition-colors my-4"
                        >
                            View Project →
                        </a>
                        </div>
